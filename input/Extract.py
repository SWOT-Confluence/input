...
TODO:
- AWS S3 versions of extract_passes and extract_data
...
class Extract:
    ...
    LOCAL_INPUT = Path("/data/data/ohio/swot")    # Temp localfile system retrieval of shapefiles
    ...
    def __init__(self, confluence_fs, reach_id, node_ids):
        ...
        self.cycle_data = extract_passes_local(int(str(reach_id)[0]), self.LOCAL_INPUT)
        # self.cycle_data = extract_passes()
        self.node_data = {}
        self.obs_times = []
...
def extract_passes(c_id, swot_dir):
    """Retrieve pass and cycle identifiers for continent from shapefiles.
